 ...
 */
import type { UpdateMailConfigurationRequestTlsMode } from './updateMailConfigurationRequestTlsMode';
...
export interface UpdateMailConfigurationRequest {
   ...
   */
  port: number;
  tlsMode: UpdateMailConfigurationRequestTlsMode;
  /** @maxLength 255 */
  username: string;
  /**
   * Leave empty to retain the existing encrypted password.
   * @maxLength 1024
   */
  password: string;
  /** @maxLength 320 */
