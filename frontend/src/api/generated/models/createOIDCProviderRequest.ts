 ...
 */
import type { CreateOIDCProviderRequestAcrAssuranceMappings } from './createOIDCProviderRequestAcrAssuranceMappings';
...
export interface CreateOIDCProviderRequest {
  ...
  enabled: boolean;
  jitEnabled: boolean;
  acrAssuranceMappings: CreateOIDCProviderRequestAcrAssuranceMappings;
}
