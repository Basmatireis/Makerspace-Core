...
import type { UpdateOIDCProviderRequestAcrAssuranceMappings } from './updateOIDCProviderRequestAcrAssuranceMappings';
...
export interface UpdateOIDCProviderRequest {
  ...
  enabled: boolean;
  jitEnabled: boolean;
  acrAssuranceMappings: UpdateOIDCProviderRequestAcrAssuranceMappings;
}
