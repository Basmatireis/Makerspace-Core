...
import type { SCIMReconciliationConflict } from './sCIMReconciliationConflict';

export interface SCIMReconciliationReport {
  canReconcile: boolean;
  provisionalAccountId: UUIDv7;
  targetAccountId: UUIDv7;
  conflicts: SCIMReconciliationConflict[];
  completed: boolean;
}
